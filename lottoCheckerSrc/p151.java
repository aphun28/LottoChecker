 ...
 */
    private void megaMillionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_megaMillionActionPerformed
    ...
    }//GEN-LAST:event_megaMillionActionPerformed

 /**
 * Handles the PowerBall option for lottery checking
 * @param evt PowerBall button being pressed
 */
    private void powerBallActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_powerBallActionPerformed
 ...
 */
    private void superLottoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_superLottoActionPerformed
        // TODO add your handling code here:
        if(this.fileChosen == false){
            JOptionPane.showMessageDialog(null, "Please select an image file", "ERROR", JOptionPane.INFORMATION_MESSAGE);
        }else{
 ...
 */
    private void chooseFileAction(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chooseFileAction
    ...
    }//GEN-LAST:event_chooseFileAction

/**
 * Handles the FantasyFive option for lottery checking
 * @param evt FantasyFive button being pressed
 */
    private void fantasyFiveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fantasyFiveActionPerformed
        if(this.fileChosen == false){
            JOptionPane.showMessageDialog(null, "Please select an image file", "ERROR", JOptionPane.INFORMATION_MESSAGE);
        }else{
            tick = new PowerBallTicket(this.ticketImgParser.getPicks());
    ...
    }//GEN-LAST:event_fantasyFiveActionPerformed
